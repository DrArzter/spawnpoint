...
const WITHOUT_PERMISSION = new Map<string, string>([
  ...
  ["POST /access/invitations/redeem", "an authenticated visitor atomically joins with a one-time invitation"],
  ["POST /access/invitations/proof", "an authenticated visitor requests proof at the invited mailbox"],
