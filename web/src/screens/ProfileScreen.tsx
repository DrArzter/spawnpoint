...
export function ProfileScreen({ member, role, viewer, onChange }: { member: Member; role?: Role; viewer: ViewerProfile; onChange: (member: Member) => void }) {
  ...
  return <>
    <div className="profile-heading">
      ...
      {viewer.inTelegram && <Button className="profile-browser-button" icon={<Icon name="external" />} onClick={openInBrowser}>Open in browser</Button>}
    </div>
