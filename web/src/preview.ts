...
export const previewSnapshot: ControlPlaneSnapshot = {
  ...
  games: [
    { id: "minecraft", code: "MC", displayName: "Minecraft", lifecycle: { schemaVersion: 1, serverId: "minecraft", desiredState: "running", observedState: "ready", activeSessionId: "session-42", updatedAtEpochSeconds: 1788028800 }, worlds: [
      { id: "world", displayName: "Modded survival", profileId: "minecraft-modded", sessionControlAvailable: true, worldLifecycleAvailable: false, connectivity: "zerotier", materialization: "existing", preset: null, connectionAddress: "172.29.23.24:25565", release: { state: "available", activeRelease: "1.2", desiredRelease: "1.2" } },
      { id: "vanilla", displayName: "Vanilla", profileId: "minecraft-vanilla", sessionControlAvailable: true, worldLifecycleAvailable: false, connectivity: "zerotier", materialization: "existing", preset: null, connectionAddress: "172.29.23.24:25565", release: { state: "available", activeRelease: "1.21", desiredRelease: "1.21" } },
    ] },
