...
import type {
  AccessCandidate, AccessIdentity, AccessRole, AccountProfile, AuthState, BackupInventory, HostMetrics, InvitationRecipient,
  InvitationSummary, LoginOptions, LoginProviderId, MetricRange, SessionOperation, SpawnpointApi, SpawnpointSession, SubscriptionState,
