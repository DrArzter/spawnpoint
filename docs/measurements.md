...
| First real S3 restore drill, 2026-08-13 | Uploaded the original **417,306,157-byte** archive to the private versioned backup bucket under a SHA-256-addressed key. Post-upload HEAD matched metadata SHA-256, S3-native SHA-256 and length. It was downloaded into `/tmp`, fully streamed and verified, restored to **635,598,718 bytes**, and `diff -qr` against the stopped source world returned no differences |
| Terraform M1 accepted-session backup, 2026-08-14 | After an in-game check of the S3-restored world, 0 players were confirmed, `save-all flush` completed and Minecraft exited 0. The new archive is **419,078,723 bytes**, SHA-256 `6a1f67097007b1025820e531f8b700f26b3b482f3139930d70451f5c33c2851a`; metadata digest, native S3 digest and byte length all matched after upload. EC2 was then stopped while encrypted EBS and S3 persisted |
| First M2 workflow stop, 2026-08-14 | The host save/stop/archive/upload command completed in **24.79 seconds**. Its archive is **419,603,323 bytes**, SHA-256 `0cb470aa7db0c2b4f060ef238a9d4bac54202c81653c3e05240734060941c777`; independent S3 HEAD matched length and metadata digest, reported AES256 and version `jfmfgqcfNcMclpoFxvui6MZpBnq8c5Xd`. The full Standard Workflow reached `SUCCEEDED` in **102.845 seconds**, after EC2 became `stopped` |
