...
mkdir -p "${output_dir}" "${lambda_dir}/dist/bot" "${lambda_dir}/dist/notifier" "${lambda_dir}/dist/world-lifecycle" "${lambda_dir}/dist/release-state" "${lambda_dir}/dist/control-plane-projector"
