...
screen at every width. It opens each route at eight viewports from 360px to 1920px, in demo mode so the pages carry
...
node tools/ui-audit/summarise.mjs audit-light.json
```
